...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		cli.StringFlag{
			Name:        "db_database_precision, lp",
			Value:       "ns",
			Usage:       "influx db database measurement precision",
			EnvVar:      "STATS_DB_DATABASE_PRECISION",
		...
		cli.IntFlag{
			Name:        "pack_points_num,pps",
			Value:       10,
			Usage:       "pack points num",
			EnvVar:      "STATS_PACKET_POINTS_NUM",
