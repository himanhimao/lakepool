...
func (self *StratumSession) Peer() cellnet.Peer {
	return self.pInterface
}

// 取原始连接
func (self *StratumSession) Raw() interface{} {
	return self.conn
}

func (self *StratumSession) Close() {
...
// 发送封包
func (self *StratumSession) Send(msg interface{}) {
...
func (self *StratumSession) IsManualClosed() bool {
	return atomic.LoadInt64(&self.closing) != 0
}

func (self *StratumSession) protectedReadMessage() (msg interface{}, err error) {
	defer func() {
...
// 接收循环
func (self *StratumSession) recvLoop() {
...
// 发送循环
func (self *StratumSession) sendLoop() {
...
// 启动会话的各种资源
func (self *StratumSession) Start() {
...
func newSession(conn net.Conn, p cellnet.Peer, endNotify func()) *StratumSession {
	self := &StratumSession{
		conn:       conn,
		endNotify:  endNotify,
